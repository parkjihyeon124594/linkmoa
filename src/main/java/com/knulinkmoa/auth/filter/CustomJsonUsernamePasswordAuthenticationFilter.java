package com.knulinkmoa.auth.filter;
...
public class CustomJsonUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String DEFAULT_LOGIN_REQUEST_URL = "/login/auth"; // "/login/auth"으로 오는 요청을 처리
    ...
    public CustomJsonUsernamePasswordAuthenticationFilter(ObjectMapper objectMapper) {
        super(DEFAULT_LOGIN_PATH_REQUEST_MATCHER); // 위에서 설정한 "/login/auth" + POST로 온 요청을 처리하기 위해
